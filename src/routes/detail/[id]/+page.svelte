...
<section class="w-full flex flex-col gap-4">
	...
	<ul class="list-disc pl-5">
		...
		<li class="mb-2">
			...
			{detail.dataumum.jk === 'L' ? 'Laki-laki' : 'Perempuan'}
		</li>
		<li class="mb-2"><span class="font-semibold">NIM:</span> {detail.dataumum.nipd}</li>
		<li class="mb-2">
			<span class="font-semibold">Nama Perguruan Tinggi:</span>
		...
		<li class="mb-2">
			<span class="font-semibold">Mulai Semester:</span>
			{yearChange(detail.dataumum.mulai_smt)}
		</li>
		<li class="mb-2">
			<span class="font-semibold">Jenis Daftar:</span>
			{detail.dataumum.nm_jns_daftar}
		</li>
		{#if detail.dataumum.nm_pt_asal}
			<li class="mb-2">
				<span class="font-semibold">Perguruan Tinggi Asal:</span>
				{detail.dataumum.nm_pt_asal}
			</li>
		{/if}
		{#if detail.dataumum.nm_prodi_asal}
			<li class="mb-2">
				<span class="font-semibold">Program Studi Asal:</span>
				{detail.dataumum.nm_prodi_asal}
			</li>
		{/if}
		<li class="mb-2">
			<span class="font-semibold">Keterangan Keluar:</span>
			{detail.dataumum.ket_keluar}
		</li>
	</ul>
</section>
