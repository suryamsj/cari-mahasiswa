...
<article class="p-4 relative w-full h-auto bg-white border-4 border-black costume-shadow">
	{#if isLink}
		<a
			class="absolute right-4 top-4 flex items-center justify-center w-10 h-10 bg-orange-400 border-2 border-black rounded-full text-white icon-shadow"
			href="/detail/{link}"
